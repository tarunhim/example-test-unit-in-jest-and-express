...
beforeEach((done) => {
  mongoose.connect("mongodb+srv://todo-emiza:todo-emiza123@cluster0.evwrlpt.mongodb.net/?retryWrites=true&w=majority", { useNewUrlParser: true,  useUnifiedTopology: true  },
    () => done());
});
